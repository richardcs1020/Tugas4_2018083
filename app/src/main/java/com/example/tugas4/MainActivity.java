...
import com.example.tugas4.HomeFragment;
import com.example.tugas4.RegistrasiFragment;
import com.example.tugas4.TheaterFragment;
...
//membuat default navigation menu select
        if(savedInstanceState == null){
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                    new RegistrasiFragment()).commit();
            navigationView.setCheckedItem(R.id.nav_registrasi);}
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem
        ...
        switch (item.getItemId()){
            case R.id.nav_home:
                ...
                break;
            case R.id.nav_registrasi:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new RegistrasiFragment()).commit();
                break;
            case R.id.nav_theater:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new TheaterFragment()).commit();
                break;}
